if (process.browser) {
  ...
  if (iOSChromeDetected) {
    ...
    const initialize = function initializeDataAttributeAndHeight(element: HTMLElement): void {
    ...
    const elements = Array.from(document.getElementsByClassName('vh-fix')) as HTMLElement[];
